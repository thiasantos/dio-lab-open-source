...
> [!NOTE]   
> Por exemplo, a URL https://github.com/thiasantos/dio-lab-open-source é o "**fork**" feito pelo usuário do GitHub "`thiasantos`" para a contribuição no repositório `dio-lab-open-source`.
